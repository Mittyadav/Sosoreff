...
1. SoSoValue Account | Register: [SoSoValue](https://sosovalue.com/join/788HHCCB)
2. Proxies
...
- Download script [Manually](https://github.com/Mittyadav/Sosoreff/archive/refs/heads/main.zip) or use git:
```bash
git clone https://github.com/Mittyadav/Sosoreff
```
